...
const FALLBACKS = {
  ...
  ar: {
    is: 'معدل ضريبة الشركات المغربي: 31% (أرباح > 100M درهم)، 20% (1M-100M درهم)، 10% (≤ 1M درهم). المادة 17-I من قانون الضرائب المغربي.',
    tva: 'ضريبة القيمة المضافة بالمغرب: النظام الحقيقي للمبيعات > 2M درهم أو الخدمات > 500K درهم. النسب: 20%، 14%، 10%، 7%.',
    fec: 'FEC (ملف القيود المحاسبية) إجباري في حال التدقيق الضريبي. معيار 2013: 15 عموداً، تنسيق CSV/UTF-8.',
    cet: 'الواجب الأدنى (CM): 0,50% من مبيعات HT (المادة 144). الحد الأدنى: 3 000 درهم. معفى منه خلال 36 شهراً الأولى (المادة 144-I-1°). قابل للخصم من ضريبة الشركات.',
    perte: 'في حال نتيجة سلبية: ضريبة الشركات = 0. ولكن الواجب الأدنى (0,50% من المبيعات، حد أدنى 3 000 درهم) يبقى مستحقاً إلا أن تكون الشركة في أول 36 شهرًا (إعفاء CM).',
    cvae: 'ضريبة القيمة المضافة بالمغرب: 20% (عام)، 14%، 10%، 7%.',
    cfe: 'رسم المهنة بالمغرب: يطبق على جميع الأنشطة المهنية. يحسب على أساس الإيرادات.',
    amort: 'الإهلاك الخطي = التكلفة × (1/العمر الإفتراضي). الإهلاك التناقصي للأصول الجديدة (العمر ≥ 3 سنوات).',
    'plus-value': 'الربح الرأسمالي بالمغرب: يضرب بنسبة ضريبة الشركات (31%/20%/10%) حسب مبلغ الربح.',
    'credit impot': 'الائتمان الضريبي للبحث بالمغرب: 30% من نفقات البحث والتطوير، بحد أقصى 10 ملايين درهم سنوياً.',
    resultat: 'النتيجة المحاسبية → النتيجة الضريبية بعد الإضافات والخصومات. التصريح حسب نموذج مديرية الضرائب.',
    seuil: 'المقاولة الصغرى بالمغرب: المبيعات ≤ 2M درهم (بضائع) أو ≤ 1M درهم (خدمات). تطبيق إعفاء ضريبة القيمة المضافة.',
  },
};
